...
namespace Bomberman.Server.Entities
{
    public class EntityMap : IEntityMap
    {
        ...
        public IEntityCell GetCell(int x, int y)
        {
            return _cells[x, y];
        }

        public IEntity GetEntity(EntityTypes type, int x, int y)
        {
        ...
        public bool MoveEntity(IEntity entity, int toX, int toY)
        {
            int fromX = entity.X;
            int fromY = entity.Y;
        ...
        // Helpers
        public void ComputeNewCoordinates(IEntity entity, Directions direction, out int newX, out int newY)
        {
            int stepX, stepY;
